export async function onRequest(context) {
    ...
    try {
        if (request.method === "DELETE") {
            ...
            const cleanContentDelete = manifestData.content.replace(/\s/g, '');
            let manifest = JSON.parse(decodeURIComponent(escape(atob(cleanContentDelete))));
        ...
        if (request.method === "POST") {
            ...
            const cleanContentPost = manifestData.content.replace(/\s/g, '');
            let list = JSON.parse(decodeURIComponent(escape(atob(cleanContentPost))));
